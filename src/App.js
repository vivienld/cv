...
function App() {
  return (
    <main className={artemis('flex-column justify-content-stretch row xs-height-auto  xs-margin-0 padding-2 xs-column-reverse')}>

      <Aside data={data} picStyle={picStyle} artemis={artemis} />

      <div className={artemis('sm-margin-0 xs-margin-0 col xs-col-12 padding-left-2 xs-padding-left-0 xs-height-auto height-100')}>
