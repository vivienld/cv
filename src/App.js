...
function App() {
  return (
    <main className={artemis('justify-content-stretch row height-100 xs-height-auto flex-column xs-margin-0 padding-2 xs-column-reverse overflow-hidden')}>

      <Aside data={data} picStyle={picStyle} artemis={artemis} />

      <div className={artemis('sm-margin-0 xs-margin-0 col xs-col-12 row vertical xs-height-fit-content padding-left-2 xs-padding-left-0 background-white overflow-auto xs-overflow-hidden xs-height-auto')}>
